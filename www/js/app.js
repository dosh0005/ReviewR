var cdApp = {
        ...
        , checkform: function () {
            ...
            if (cdApp.f_edit_id > 0) {
                ...
                navigator.camera.getPicture(cdApp.camOnSuccess, cdApp.camOnFail, {
                ...
                img.src = imageData;
                cdApp.f_add_img_url = imageData;
                cdApp.f_add_img.innerHTML = "";
                cdApp.f_add_img.appendChild(img);
                cdApp.f_add_img.classList.remove('hide');
            }, camOnFail: function (message) {
                ...
                if (cdApp.f_edit_id) {
                    ...
                    var img = document.createElement('img');
                    img.src = cdApp.f_edit_img_url;
                    cdApp.f_edit_img.innerHTML = "";
                    cdApp.f_edit_img.appendChild(img);
                    cdApp.setRatingEdit();
                }
                else {
